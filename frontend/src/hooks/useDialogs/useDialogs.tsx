...
//     //       onSubmit: React.FormEventHandler<HTMLFormElement> = async (event: any) => {
...
// const DialogsContext = createContext<DialogHook | null>(null);

// export const DialogsProvider: React.FC<{ children: React.ReactNode }> = ({
//   children,
// }) => {
//   const [alertState, setAlertState] = useState<AlertDialogPayload | null>(null);
//   const [confirmState, setConfirmState] =
//     useState<ConfirmDialogPayload | null>(null);
//   const [promptState, setPromptState] =
//     useState<PromptDialogPayload | null>(null);

//   const alert: OpenAlertDialog = (options) => {
//     setAlertState(options);
//   };

//   const confirm: OpenConfirmDialog = (options) => {
//     return new Promise<boolean>((resolve) => {
//       setConfirmState({
//         ...options,
//         onClose: resolve,
//       } as ConfirmDialogPayload);
//     });
//   };

//   const prompt: OpenPromptDialog = (options) => {
//     return new Promise<string | null>((resolve) => {
//       setPromptState({
//         ...options,
//         onClose: resolve,
//       } as PromptDialogPayload);
//     });
//   };

//   const value: DialogHook = {
//     alert,
//     confirm,
//     prompt,
//   };
