        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnualLimit = table.Column<decimal>(type: "decimal(5,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAllowed = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    Used = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    Remaining = table.Column<decimal>(type: "decimal(5,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeLeaveBalance", x => x.BalanceId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveTypeId = table.Column<int>(type: "int", nullable: false),
                    DayType = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveRequestId = table.Column<int>(type: "int", nullable: false),
                    LeaveTypeId = table.Column<int>(type: "int", nullable: false),
                    DaysUsed = table.Column<decimal>(type: "decimal(5,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveRequestDetails", x => x.DetailId);
                    table.ForeignKey(
                        name: "FK_LeaveRequestDetails_LeaveRequests_LeaveRequestId",
            ...
            migrationBuilder.InsertData(
                table: "LeaveTypes",
                columns: new[] { "LeaveTypeId", "AnnualLimit", "LeaveCode", "LeaveName" },
                values: new object[,]
                {
                    { 1, 12m, "CL", "Casual Leave" },
                    { 2, 10m, "SL", "Sick Leave" },
                    { 3, null, "LOP", "Loss of Pay" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequestDetails_LeaveRequestId",
